      ...
      >
        <div class="container">
          <a href="#" class="navbar-brand" style="font-weight:500;">
            <span class="header-style">Chow-</span>Mart
          </a>
          ...
          <div class="collapse navbar-collapse" id="miniNavbar">
            <ul class="navbar-nav ml-auto">
              ...
              <router-link tag="li" exact to="/" active-class="active" class="nav-item">
              ...
              >
                <span class="nav-link">
                  <h7>
                    <icon name="cart-plus" scale="1"></icon>
                    ( {{cart.length}} )
                  </h7>
                </span>
              </router-link>
...
.sign:hover {
  color: #fff !important;
  background-color: #4fc7b3 !important;
